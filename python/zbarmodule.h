...
typedef struct
{
	PyLongObject	val;			/* integer value is super type */
    PyObject* 		name;			/* associated string name */
} zbarEnumItem;

extern PyTypeObject		zbarEnumItem_Type;

extern zbarEnumItem* zbarEnumItem_New(PyObject *byname, PyObject *byvalue, int val, const char *name);
...
extern zbarSymbolSet*	zbarSymbolSet_FromSymbolSet(const zbar_symbol_set_t *zsyms);
