...
static char imagescanner_doc[] = PyDoc_STR("scan images for barcodes.\n\nattaches symbols to image for each decoded result.");

static zbarImageScanner* imagescanner_new (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static zbarSymbolSet* imagescanner_get_results (zbarImageScanner *self, void *closure)
{
...
static PyObject* imagescanner_enable_cache (zbarImageScanner *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|O&", kwlist, object_to_bool, &enable))
	{
		return(NULL);
	}
...
{
	{ "set_config",		(PyCFunction)imagescanner_set_config,	METH_VARARGS | METH_KEYWORDS, },
	{ "parse_config",	(PyCFunction)imagescanner_parse_config,	METH_VARARGS | METH_KEYWORDS, },
	{ "enable_cache",	(PyCFunction)imagescanner_enable_cache,	METH_VARARGS | METH_KEYWORDS, },
	{ "recycle",		(PyCFunction)imagescanner_recycle,		METH_VARARGS | METH_KEYWORDS, },
	{ "scan",			(PyCFunction)imagescanner_scan,			METH_VARARGS | METH_KEYWORDS, },
	{ NULL, },
};
