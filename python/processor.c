...
static char processor_doc[] = PyDoc_STR("low level decode of measured bar/space widths.\n\nFIXME.");

static zbarProcessor* processor_new (PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
{
	{ "visible",  (getter)processor_get_bool, (setter)processor_set_bool, NULL, (void*)0 },
...
static PyObject* processor_set_config (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|iii", kwlist, &sym, &cfg, &val))
	{
		return(NULL);
	}
...
static PyObject* processor_init_ (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|zO&", kwlist, &dev, object_to_bool, &disp))
	{
		return(NULL);
	}
...
static PyObject* processor_parse_config (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	{
		PyErr_Format(PyExc_ValueError, "invalid configuration setting: %s", cfg);
		return(NULL);
	}
...
static PyObject* processor_user_wait (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|O&", kwlist, object_to_timeout, &timeout))
	{
		return(NULL);
	}
...
static PyObject* processor_process_image (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "O!", kwlist, &zbarImage_Type, &img))
	{
		return(NULL);
	}
...
static PyObject* processor_set_data_handler (zbarProcessor *self, PyObject *args, PyObject *kwds)
{
	...
	if (!PyArg_ParseTupleAndKeywords(args, kwds, "|OO", kwlist, &handler, &closure))
	{
		return(NULL);
	}
	if(handler != Py_None && !PyCallable_Check(handler))
	{
		PyErr_Format(PyExc_ValueError, "handler %.50s is not callable", handler->ob_type->tp_name);
		return(NULL);
	}
	Py_CLEAR(self->handler);
	Py_CLEAR(self->closure);
...
{
	{ "init",             (PyCFunction)processor_init_,				METH_VARARGS | METH_KEYWORDS, },
	{ "set_config",       (PyCFunction)processor_set_config,		METH_VARARGS | METH_KEYWORDS, },
	{ "parse_config",     (PyCFunction)processor_parse_config,		METH_VARARGS | METH_KEYWORDS, },
	{ "user_wait",        (PyCFunction)processor_user_wait,			METH_VARARGS | METH_KEYWORDS, },
	{ "process_one",      (PyCFunction)processor_process_one,		METH_VARARGS | METH_KEYWORDS, },
	{ "process_image",    (PyCFunction)processor_process_image,		METH_VARARGS | METH_KEYWORDS, },
	{ "set_data_handler", (PyCFunction)processor_set_data_handler,	METH_VARARGS | METH_KEYWORDS, },
	{ NULL, },
};
